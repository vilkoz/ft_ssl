...
for _ in range(100):
    ...
    try:
        encoded_text = co("printf \"" + s + "\" | ../../ft_ssl des-ecb -e -k 1122334455667788 -a", shell=True);
        ssl_encoded = co("printf \"" + s + "\"| openssl des-ecb -e -K 1122334455667788 -a", shell=True);
        decoded_text = co("printf \"" + ssl_encoded.decode() + "\"| ../../ft_ssl des-ecb -d -k 1122334455667788 -a", shell=True);
        ssl_decoded = co("printf \"" + ssl_encoded.decode() + "\"| openssl des-ecb -d -K 1122334455667788 -a", shell=True);
